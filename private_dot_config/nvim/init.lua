if vim.g.vscode then
  ...
  keymap('n', '<leader>ca', "<cmd>lua require('vscode').action('editor.action.sourceAction')<CR>")
  ...
  require('lazy').setup({
...

    {
      ...
      config = function()
        ...
        vim.keymap.set('n', '<C-,>', ':Neotree toggle<Return>')
        vim.keymap.set('v', '<C-,>', ':Neotree toggle<Return>')
